# Σύμβαση έργου για τον σχεδιασμό και την ανάπτυξη του διαδικτυακού τόπου [website.com]
...
Θα δημιουργήσουμε σχέδια (designs) για την αισθητική, τη διάταξη και τη λειτουργικότητα του διαδικτυακού τόπου σας. Ο σχεδιασμός περιλαμβάνει τα παρακάτω στάδια:

* **Στατικός σχεδιασμός μίας ιστοσελίδας (Αρχική Σελίδα)**  Κατά τη διάρκεια του στάδιου αυτού θα αποφασίσουμε από κοινού τη γενικότερη αισθητική (look and feel) της ιστοσελίδας, καθώς και θα συμπεριλάβουμε όλα τα απαραίτητα στοιχεία από πλευράς περιεχομένου που θα ενσωματωθούν. Ο σχεδιασμός θα αφορά στατικές εικόνες.

* **Σχεδιασμός των υπόλοιπων προτύπων ιστοσελίδων (Layout Templates)**  Στο στάδιο αυτό θα σχεδιάσουμε τα υπόλοιπα μοναδικά πρότυπα σελίδων (templates) που αφορούν το έργο και θα αναπτύξουμε τον αντίστοιχο κώδικα σε HTML, CSS, JavaScript. 

* **Σχεδιασμός για φορητές συσκευές (Responsive Web Design)**  Τέλος, θα σχεδιάσουμε το πως ο διαδικτυακός σας τόπος θα εμφανίζεται βελτιστοποιημένα σε φορητές συσκευές. Για να το επιτύχουμε αυτό θα εφαρμόσουμε την τεχνική Responsive Web Design, βάσει της οποίας το περιεχόμενο προσαρμόζεται στη συσκευή του επισκέπτη. Δε θα δημιούργησουμε κάποια διαφορετική έκδοση των ιστοσελίδων σας δεύτερη φορά, καθώς αυτό θα ήταν κάτι μη αποδοτικό για εσάς.
...
Επιπλέον, δεν είμαστε υπεύθυνοι για το πέρασμα των τελικών κειμένων στον διαδικτυακό σας τόπο. Εμείς θα περάσουμε ενδεικτικό υλικό (κείμενα & φωτογραφίες) και στη συνέχεια θα σας εκπαιδεύσουμε ώστε να το κάνετε μόνοι σας. \
Η σύμβαση αυτή περιλαμβάνει εκπαίδευση [αριθμός ωρών] ωρών. 
...
### ΑΝΑΠΤΥΞΗ ΔΙΑΔΙΚΤΥΑΚΟΥ ΤΟΠΟΥ

Η ανάπτυξη του διαδικτυακού τόπου θα γίνει στο Σύστημα Διαχείρισης Περιεχομένου [Σύστημα Διαχείρισης Περιεχομένου] Εμείς θα αναλάβουμε την εγκατάσταση, παραμετροποίηση κι εφαρμογή των layout templates στο συγκεκριμένο λογισμικό καθώς επίσης κι όλες τις απαραίτητες ενέργειες για την απρόσκοπτη κι επιτυχημένη λειτουργία του διαδικτυακού τόπου.

Η ανάπτυξη του διαδικτυακού τόπου περιέχει εργασίες, οι οποίες έχουν αναλυθεί εμπεριστατωμένα σε προηγούμενη μας επικοινωνία είτε μέσω της προσφοράς που έχει κατατεθεί σε εσάς, είτε μέσω ηλεκτρονικής αλληλογραφίας, είτε μέσω συναντήσεων. Με τη σύμβαση αυτή αποδέχεστε την εγκυρότητα των συνομιλιών και των συμφωνίων αυτών.

Η ανάπτυξη του διαδικτυακού τόπου θα γίνει σε [αριθμός γλωσσών] γλώσσες: τα [γλώσσες ονομαστικά]

### ΑΛΛΑΓΕΣ ΚΑΙ ΑΝΑΘΕΩΡΗΣΕΙΣ

Γνωρίζουμε με βάση την εμπειρία μας ότι οι συμβάσεις στις οποίες έχει προαποφασιστεί το κόστος είναι συχνά μη ωφέλιμες για εσάς, καθώς μπορεί να περιορίσουν τις ιδέες σας για το πώς να φαίνονται κάποια πράγματα ή πώς να λειτουργούν. Δεν επιθυμούμε να περιορίσουμε τις επιλογές σας ή την ευκαιρία να αλλάξετε άποψη για κάποια πράγματα.

Οι εκτιμώμενες τιμές βασίζονται στον αριθμό των ημερών που υπολογίζουμε ότι θα χρειαστούμε να ικανοποιήσουμε όλα όσα μας έχετε πει ότι θέλετε να πετύχετε. Αν όμως έχετε αλλάξει τη γνώμη σας, θέλετε να προσθέσετε επιπλέον ιστοσελίδες ή πρότυπα ιστοσελίδων ή ακόμα νέες πτυχές στη λειτουργικότητα, θα πρέπει να συμφωνήσουμε από κοινού σε ένα νέο ποσό, το οποίο θα σας χρεώσουμε. Παράλληλα, θα σας ζητήσουμε να καταγράψετε τα νέα χαρακτηριστικά του έργου ώστε να μπορούμε να ελέγχουμε τις αλλαγές.
...
Ωστόσο, θεωρούμε δεδομένο ότι αν υπάρξουν λόγοι ανωτέρας βίας για οποιοδήποτε από τα δύο μέρη είναι λογικό να αναστείλει προσωρινά ή οριστικά τις δρασητριότητές του. 

Με αυτή τη σύμβαση συμφωνούμε αμοιβαία να τηρούμε τους ισχύοντες νόμους και να μοχθήσουμε από κοινού για την επιτυχία του έργου με πνεύμα συνεργασίας και αλληλοεκτίμησης. 

## Πνευματικά δικαιώματα

Εγγυάστε σε εμάς ότι οποιαδήποτε τμήματα κειμένων, γραφικών, φωτογραφιών, σχεδίων, σημάτων ή άλλου περιεχομένου που μας παρέχετε για να συμπεριληφθεί στον διαδικτυακό τόπο ανήκει σε εσάς ή έχετε άδεια για να το χρησιμοποιήσετε.
...
Το ποσό κάθε δόσης δεν επιστρέφεται για κανένα λόγο σε περίπτωση διακοπής της συνεργασίας μας, για οποιαδήποτε αιτία, με πρωτοβουλία δική σας.
...
Αν και η γλώσσα που χρησιμοποιήσαμε είναι απλή, οι προθέσεις είναι σοβαρές και αυτή η σύμβαση είναι ένα νόμιμο έγγραφο υπό την αποκλειστική δικαιοδοσία των Ελληνικών δικαστηρίων και συγκεκριμένα της [όνομα πόλης]. 

## Τρόπος πληρωμών

Η πληρωμή για το έργο θα γίνει σε δύο (2) δόσεις:

- [ποσό ολογράφως] [ποσό με νούμερο] με την υπογραφή αυτής της σύμβασης.
- [ποσό ολογράφως] [ποσό με νούμερο] με την ολοκλήρωση του έργου.

Σε καθένα από τα ποσά αυτά συμπεριλαμβάνεται ο νόμιμος ΦΠΑ 24% κι έχει αφαιρεθεί η παρακράτηση φόρου 20%.

Τα ανωτέρω ποσά αφορούν μετρητά ή κατάθεση στην [όνομα τράπεζας] στον παρακάτω αριθμό IBAN: [αριθμός IBAN]

Για κάθε καταβολή θα κοπεί και το αντίστοιχο τιμολόγιο. 
...
- Παράδοση πρότυπου εμφάνισης ιστοσελίδας (σε στατική μορφή): Σε περίπου [αριθμός ολογράφως] [αριθμός με νούμερο] εβδομάδες από την υπογραφή της σύμβασης. \
...
**Παραδοτέα**: Αρχεία εικόνας

- Παράδοση πρότυπων εμφάνισης ιστοσελίδας (σε HTML μορφή): Σε περίπου [αριθμός ολογράφως] [αριθμός με νούμερο] εβδομάδες από την ολοκλήρωση του προηγούμενου βήματος.\
**Παραδοτέα**: Ο HTML, CSS, JavaScript κώδικας σε μορφή ιστοσελίδας (περιλαμβάνει το σχεδιασμό για φορητές συσκευές).
- Ολοκλήρωση Ανάπτυξης: Σε περίπου [αριθμός εβδομάδων ολογράφως] [αριθμός εβδομάδων με νούμερο] εβδομάδες μετά την ολοκλήρωση του προηγούμενου βήματος.\
