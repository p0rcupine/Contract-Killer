...
Θα δημιουργήσουμε σχέδια (designs) για την αισθητική, τη διάταξη και τη λειτουργικότητα της ιστοσελίδας σας. Παρότι η δική μας δουλειά περιλαμβάνει τη χρήση πολλών διαφορετικών εργαλείων και τεχνικών, εσείς θα λαμβάνετε τα προσχέδια προς έγκριση σε μορφή HTML, δηλαδή θα τα βλέπετε στο φυλλομετρητή (browser) σας κι όχι ως στατική εικόνα. Με τον τρόπο αυτόν θα έχετε μια ακριβή ιδέα του τελικού αποτελέσματος.
...
Η ανάπτυξη της ιστοσελίδας θα γίνει στο Σύστημα Διαχείρισης Περιεχομένου ................................. Εμείς θα αναλάβουμε την εγκατάσταση, παραμετροποίηση κι εφαρμογή των layout templates στο συγκεκριμένο λογισμικό καθώς επίσης κι όλες τις απαραίτητες ενέργειες για την απρόσκοπτη κι επιτυχημένη λειτουργία της ιστοσελίδας.
